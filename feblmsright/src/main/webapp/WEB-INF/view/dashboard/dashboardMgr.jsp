...
<script type="text/javascript">
      ...
      $(document).ready(function() {
         ...
         selectComCombo("lecbyuser", "lecbyuserall", "all", "");   // 시험 정보 : testall : selectbox ID   value : test_no          all : 전체     sel : 선택 
         comcombo("test_type", "testall", "all", "");
    ...
    function inputkey(event) {
      ...
      function fInitFormGrpCod(object) {
         ...
         if( object == "" || object == null || object == undefined) {
            divComGrpCoddetail.grp_cod = "";
            divComGrpCoddetail.grp_cod_nm = "";
            divComGrpCoddetail.grp_cod_eplti = "";
            divComGrpCoddetail.mp_fld_01 = "";
            divComGrpCoddetail.mp_fld_02 = "";
            divComGrpCoddetail.mp_fld_03 = "";
            divComGrpCoddetail.use_poa = "Y";
            divComGrpCoddetail.fst_enlm_dtt = "";
            divComGrpCoddetail.reg_date = "";
            divComGrpCoddetail.fst_rgst_sst_id = "";
            divComGrpCoddetail.fnl_mdfd_dtt = "";
            divComGrpCoddetail.fnl_mdfr_sst_id = "";
            divComGrpCoddetail.detailcnt = 0;
            divComGrpCoddetail.delshow = false;
            
            divComGrpCoddetail.action = "I";
      ...
      function fSaveGrpCod() {
         ...
         var param = {
               ...
               action : divComGrpCoddetail.action
         }
                  ...
                  <br>
                     ...
                     <p class="conTitle" style="margin-bottom: 1%;">
                        ...
                        <span class="fr"> 
                          ...
                          <a class="btnType blue" href="javascript:fn_grpcdnew()" name="modal"><span>신규등록</span></a>
                           <table class="col">
