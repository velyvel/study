...
<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			selectComCombo("test", "testall", "all", "");   // 시험 정보 : testall : selectbox ID   value : test_no          all : 전체     sel : 선택 
		
			userCombo("usr", "B", "usrall", "all", "");   // 사용자 정보 : B : usertype      usrall :selectbox ID   value : loginID          all : 전체     sel : 선택 
			
			selectComCombo("lecbyuser", "lecbyuserall", "all", "");    // 강의 정보 : lecbyuser : selectbox ID   value : detail_code          all : 전체     sel : 선택 
			
			selectComCombo("room:", "roomall", "all", "");   // 강의실 정보:      roomall : selectbox ID   value : room_seq          all : 전체     sel : 선택 
			
			selectComCombo("room:Y", "roomy", "all", "");   // 강의실 정보:Y     roomy : selectbox ID   value : room_seq          all : 전체     sel : 선택 
			
			selectComCombo("room:N", "roomn", "all", "");   // 강의실 정보:N     roomn : selectbox ID   value : room_seq          all : 전체     sel : 선택 
			
			selectComCombo("lecseqbyuser", "lecseqbyuserall", "all", "");   // 강의 정보 : lecseqbyuser : selectbox ID   value : lecture_seq          all : 전체     sel : 선택 
					...
					<div class="content" style="margin-bottom:20px;">
						...
						<div>
								        <table>
										    <tbody>
										          <tr>
										               <td><b><h6>시험목록</h6></b></td>
										               <td>
										                       <select id="testall"  name="testall" > </select>
										               </td>
										               <td><b><h6>시용자목록</h6></b></td>
										               <td>
										                       <select id="usrall"  name="usrall" > </select>
										               </td>		
										               <td><b><h6>로그인 강사 과정</h6></b></td>
										               <td>
										                       <select id="lecbyuserall"  name="lecbyuserall" > </select>
										               </td>	
										               <td><b><h6>로그인 강사 과정 lecture_seq</h6></b></td>
										               <td>
										                       <select id="lecseqbyuserall"  name="lecseqbyuserall" > </select>
										               </td>	
										               
										           </tr>
										           <tr>
										               <td><b><h6>전체 강의실</h6></b></td>
										               <td>
										                       <select id="roomall"  name="roomall" > </select>
										               </td>
										               <td><b><h6>사용중 강의실</h6></b></td>
										               <td>
										                       <select id="roomy"  name="roomy" > </select>
										               </td>		
										               <td><b><h6>빈 강의실</h6></b></td>
										               <td colspan=3>
										                       <select id="roomn"  name="roomn" > </select>
										               </td>	
										           </tr>
										     </tbody>
										  </table>               
