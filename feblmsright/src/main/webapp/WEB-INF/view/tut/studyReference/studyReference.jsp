...
<script type="text/javascript">
	...
	function fn_referenceselectlist(pagenum){
		...
		var listcallback = function(returndata) {
			...
			$("#ReferenceList").empty().append(returndata);
		...
		callAjax("/tut/referenceselectlist.do", "post" , "text", "false", param, listcallback);
	...
	function fn_referenceSelectForm(referenceinfo){
		...
		if(referenceinfo == null || referenceinfo == "" || referenceinfo == undefined){
			
			$("#lecture_seq").val($("#lectureseq").val());
			$("#reference_no").val("");
			$("#reference_title").val("");
			$("#reference_content").val("");
			$("#reference_file").val("");
	...
	function fn_referencemodify(referenceno){
		...
		callAjax("/tut/referenceselect.do", "post", "json", "false", param, selectcallback);
