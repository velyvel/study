...
function userCombo(comtype,code, combo_name, type, selvalue){
...
// userbylecseqCombo('userbylec','4','aaaa','all','');
function userbylecseqCombo(comtype,code, combo_name, type, selvalue){
